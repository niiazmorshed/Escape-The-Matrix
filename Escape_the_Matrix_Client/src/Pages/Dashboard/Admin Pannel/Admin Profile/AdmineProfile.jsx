            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="bg-gray-800 rounded-2xl shadow-lg border border-gray-700 overflow-hidden">
                    <div className="bg-gray-700 px-8 py-6">
                        ...
                        <p className="text-gray-300 mt-1">Full administrative access to the platform</p>
                    </div>
                            ...
                            <div className="flex-1 text-center md:text-left">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center justify-center md:justify-start">
                                        ...
                                        <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-red-900/40 text-red-200">
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-700">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="bg-gray-700 rounded-lg p-4">
                                    ...
                                    <p className="font-semibold text-blue-400">Full Access</p>
                                </div>
                            </div>
                        </div>
                    </div>
